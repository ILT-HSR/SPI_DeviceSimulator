// SPITemplate.cpp : Definiert den Einstiegspunkt f�r die Konsolenanwendung.
//
...
int _tmain()
{
	...
	std::shared_ptr<SPI::DeviceSimulator::ResourceProvider> resourceProvider(new SPI::DeviceSimulator::ResourceProvider());

	// Create SpecificCoreContainer
	std::shared_ptr<SPI::DeviceSimulator::SpecificCoreContainer> specificCoreContainer(new SPI::DeviceSimulator::SpecificCoreContainer(resourceProvider));
